        ...
        <div class="max-w-md w-full space-y-6">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-amber-400/20">
                ...
                <form class="space-y-6" id="registerForm">
                    ...
                    <!-- WhatsApp Field -->
                    <div>
                        <label for="whatsapp" class="block text-sm font-semibold text-amber-100 mb-2">
                            Nomor WhatsApp
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            registerForm.addEventListener('submit', function(e) {
                ...
                registerBtn.textContent = 'Mengirim OTP...';
                registerBtn.disabled = true;
            ...
            whatsappInput.addEventListener('input', validatePassword);
